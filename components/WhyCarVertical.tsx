...
export default async function WhyAutoFactsCheck() {
  ...
  try {
    ...
    if (process.env.NODE_ENV !== 'production') console.warn('[i18n] Could not read cookies/headers in WhyAutoFactsCheck:', e)
  }
