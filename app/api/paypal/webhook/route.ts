              ...
              if (customerEmail) {
                const customerEmailContent = `
                  <div style="font-family: sans-serif; max-width: 600px; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                    ...
                    <p style="margin-top: 20px; color: #666; font-size: 14px;">Thank you for choosing Car Bronze! If you have any questions, please contact us.</p>
                    <p>Best Regards,<br/><strong>Car Bronze Team</strong></p>
                  </div>
                `
