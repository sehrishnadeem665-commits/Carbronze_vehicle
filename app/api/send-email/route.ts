...
function generatePaymentSuccessAdminEmail(data: any): string {
  return `
    <div style="font-family: sans-serif; max-width: 600px; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
      ...
      <p>Hello Admin,</p>
      <p>A new payment has been received for a vehicle history report via <strong>AutoFactsCheck</strong>.</p>
      ...
      <p style="margin-top: 20px; color: #666; font-size: 14px;">The order has been marked as completed in the database for AutoFactsCheck.</p>
    </div>
  `
}
...
function generatePaymentSuccessCustomerEmail(data: any): string {
  return `
    <div style="font-family: sans-serif; max-width: 600px; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
      ...
      <p>Best Regards,<br/><strong>AutoFactsCheck</strong></p>
    </div>
  `
}
